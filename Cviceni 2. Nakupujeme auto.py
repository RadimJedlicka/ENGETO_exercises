# V Python oknu už máš vypsané ceny Mercedesu, Rolls-Royce a příplatkové výbavy. Poté bude třeba spočítat a uložit do proměnných:
#
...
print("Cena za Mercedes a Rolls-Royce:", mer_rols)
